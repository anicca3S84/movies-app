...
//        recyclerView.itemAnimator = CustomItemAnimator()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.itemResponse.observe(viewLifecycleOwner, Observer { apiResponse ->
        ...
        viewModel.searchResponse.observe(viewLifecycleOwner, Observer { searchResponse ->
...
//                viewModel.getNewFilms(1, 20)
        ...
        viewModel.seriesResponse.observe(viewLifecycleOwner, Observer { seriesResponse ->
        ...
        viewModel.categoriesResponse.observe(viewLifecycleOwner, Observer { categoriesResponse ->
...
//        })
            ...
            when (event.action) {
                MotionEvent.ACTION_DOWN -> {
                    ...
                    animateBackgroundColor(
                        textChoice1,
                        ContextCompat.getColor(requireContext(), R.color.g_blue_gray200)
                    )
                    true
                }
                ...
                MotionEvent.ACTION_CANCEL -> {
                    animateBackgroundColor(
                        textChoice1,
                        ContextCompat.getColor(requireContext(), R.color.dark_color)
                    )
                    true
                }
    ...
    private fun animateBackgroundColor(view: View, color: Int) {
        val colorFrom = (view.background as? ColorDrawable)?.color ?: ContextCompat.getColor(
            requireContext(),
            R.color.dark_color
        )
        val colorTo = color
    ...
    private fun reloadFragment() {
        ...
        handler2.postDelayed({
            viewModel.getNewFilms(randomPage, randomCount)
